# ==============================================================================
# 06e_generate_figures.R
# Create coefficient plots and task trend figures
# ==============================================================================

# ==============================================================================
# FIGURE 1: Coefficient Plot — Replication vs ALM
# ==============================================================================
...
fig1 <- ggplot(all_coefs, aes(x = decade, y = coef, color = source, shape = source)) +
  ...
  labs(
    title = "Figure 1: Coefficient Estimates by Decade",
...
ggsave(file.path(OUTPUT, "02_figures", "fig1_coefficient_plot.png"),
       fig1, width = 10, height = 8, dpi = 300)
cat("Saved fig1_coefficient_plot.png\n")

# ==============================================================================
# FIGURE 2: Weighted Mean Task Changes by Decade
# ==============================================================================
...
fig2 <- ggplot(all_wmeans, aes(x = decade, y = wmean, fill = period)) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "gray50") +
  geom_col(width = 0.6) +
  facet_wrap(~ panel, ncol = 2, scales = "free_y") +
  scale_fill_manual(values = c("Part I (DOT)" = "#4393c3", "Part II (O*NET)" = "#7fbc41")) +
  labs(
    title = "Figure 2: Economy-Wide Task Changes by Decade",
...
ggsave(file.path(OUTPUT, "02_figures", "fig2_task_trends.png"),
       fig2, width = 10, height = 8, dpi = 300)
cat("Saved fig2_task_trends.png\n")